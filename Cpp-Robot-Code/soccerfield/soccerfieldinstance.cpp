...
SoccerFieldInstance::SoccerFieldInstance(SoccerFieldInstance::Parameter params) : params(params) {
    ...
    // right side-out line
    fieldLines.emplace_back(-fieldLength() / 2, -fieldWidth() / 2, fieldLength() / 2, -fieldWidth() / 2);
    // left side-out line
    fieldLines.emplace_back(-fieldLength() / 2, fieldWidth() / 2, fieldLength() / 2, fieldWidth() / 2);
    // own goal-out line
    fieldLines.emplace_back(-fieldLength() / 2, -fieldWidth() / 2, -fieldLength() / 2, fieldWidth() / 2);
    ...
    fieldLines.emplace_back(-fieldLength() / 2 + params.penaltyAreaWidth, -params.penaltyAreaHeight / 2,
    ...
    borderLines.emplace_back(-fieldLength() / 2 - params.fieldBorder, -fieldWidth() / 2 - params.fieldBorder,
